...
class Orbitals:
    ...
    def compute(self, potential, bc, init=False, eig_guess=False):
        ...
        if bc != "bands":
            self._eigfuncs[0], self._eigvals[0] = numerov.matrix_solve_wrapper(
                v,
                self._xgrid,
                bc,
            ...
            eigfuncs_l, self._eigvals_min = numerov.matrix_solve_wrapper(
                v,
                self._xgrid,
                "neumann",
                eigs_min_guess=self._eigs_min_guess[0],
            ...
            eigfuncs_u, self._eigvals_max = numerov.matrix_solve_wrapper(
                v,
                self._xgrid,
                "dirichlet",
